...
<html>
	<head>
        ...
        <title> Discover The Pub &amp; Visit Your Local Pub Location | Experience The Pub</title>
	...
	<body>
		...
		<div data-role="footer" data-theme="<?php echo $theme ?>" data-position="fixed">
            <h1>Powered by <a href="http://www.mobilegrows.com" rel="external">MobileGrows</a> | <a href="http://www.experiencethepub.com/" rel="external">Desktop Site</a></h1>
		...
		<div data-role="page" id="page1" data-theme="<?php echo $theme ?>">
		  ...
		  <div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
              ...
              <fieldset class="ui-grid-b" data-theme="<?php echo $theme ?>">
                  ...
                  <div class="ui-block-a"><a href="#myPopuptelephone" class="callfindmail ui-btn buttons-radius" data-rel="popup" data-transition="flow"><img src="img/poziv.png"></a></div>
                  <!-- ovdje se upisuje grad i adresa iz koje  -->
                  <div class="ui-block-b" id="findUS"><a href="#myPopup" class="callfindmail ui-btn buttons-radius" data-rel="popup" data-transition="flow"><img src='img/lokacija.png'></a></div>
              ...
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                  <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Events</a>
                  </div>
              </div>
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                  <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">News</a>
                  </div>
              </div>
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                  <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Pub Gifts</a>
                  </div>
              </div>
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                  <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Parties</a>
                  </div>
              </div>
		  </div>
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<section id="navigation-menu">
						<ul id="menu">
                            ...
                            <li><a href="#page1" data-transition="<?php echo $transitionefect ?>">News</a></li>
                            <li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Pub Gifts</a></li>
                            <li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Parties</a></li>
